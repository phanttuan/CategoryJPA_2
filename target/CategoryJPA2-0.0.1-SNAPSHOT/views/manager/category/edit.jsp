...
<div class="container my-4">
    <div class="mb-3">
        <a href="${pageContext.request.contextPath}/manager/category" class="text-decoration-none">
            ← Quay lại danh sách
        </a>
    </div>
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form method="post" action="${pageContext.request.contextPath}/manager/category/edit" enctype="multipart/form-data">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="${pageContext.request.contextPath}/manager/category" class="btn btn-secondary">Hủy</a>
                </div>
            </form>
        </div>
    </div>
